    ...
    (function() {
        ...
        function initializeHeavenlyUpgrades() {
            ...
            if (!window._huGardenPlantUnlockHooked) {
                ...
                window._huGardenPlantUnlockHooked = true;
            }
        }
            ...
            if (saveData.farmDropCookies && Object.keys(saveData.farmDropCookies).length > 0) {
                for (var cookieName in saveData.farmDropCookies) {
                    ...
                    if (upgrade) {
                        ...
                        console.log('[HU Save/Load] Farm drop upgrade not found:', cookieName);
                    }
                }
            } else {
