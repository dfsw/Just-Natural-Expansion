    ...
    (function() {
        ...
        if (Game.Has('Doordashing every day') || Game.Has('Second day takeout') || Game.Has('Chinese leftovers')) {
            if (!Game.JNE.fortuneTimers) Game.JNE.fortuneTimers = {};
            ...
            if (now) {
                ...
                if (interval) {
                    ...
                    var gcLastUsedTime = Game.JNE.fortuneTimers.fortuneGCLastUsedTime;
                    if (gcUsed && !gcLastUsedTime) {
                        Game.JNE.fortuneTimers.fortuneGCLastUsedTime = now;
                    } else if (gcLastUsedTime && (now - gcLastUsedTime >= interval)) {
                        Game.fortuneGC = 0;
                        delete Game.JNE.fortuneTimers.fortuneGCLastUsedTime;
                    }
                    var cpsUsed = (Game.fortuneCPS === 1);
                    var cpsLastUsedTime = Game.JNE.fortuneTimers.fortuneCPSLastUsedTime;
                    if (cpsUsed && !cpsLastUsedTime) {
                        Game.JNE.fortuneTimers.fortuneCPSLastUsedTime = now;
                    } else if (cpsLastUsedTime && (now - cpsLastUsedTime >= interval)) {
                        Game.fortuneCPS = 0;
                        delete Game.JNE.fortuneTimers.fortuneCPSLastUsedTime;
                    }
                }
            }
        }
    ...
    function setupImprovedCookieChains() {
        ...
        function getSaveData() {
            try {
                ...
                if (Game.JNE.fortuneTimers) {
                    if (Game.JNE.fortuneTimers.fortuneGCLastUsedTime !== undefined) {
                        saveData.timers.fortuneGCLastUsedTime = Game.JNE.fortuneTimers.fortuneGCLastUsedTime;
                    }
                    if (Game.JNE.fortuneTimers.fortuneCPSLastUsedTime !== undefined) {
                        saveData.timers.fortuneCPSLastUsedTime = Game.JNE.fortuneTimers.fortuneCPSLastUsedTime;
                    }
                }
            ...
            try {
                ...
                if (saveData.timers) {
                    ...
                    if (saveData.timers.fortuneGCLastUsedTime !== undefined) {
                        Game.JNE.fortuneTimers.fortuneGCLastUsedTime = saveData.timers.fortuneGCLastUsedTime;
                    }
                    if (saveData.timers.fortuneCPSLastUsedTime !== undefined) {
                        Game.JNE.fortuneTimers.fortuneCPSLastUsedTime = saveData.timers.fortuneCPSLastUsedTime;
                    }
                }
